...
$pdf->SetTitle('Reporte de Usuarios Administradores');
$pdf->SetSubject('Admin User Report');
$pdf->SetKeywords('PDF, report, admin, user');
...
$pdf->SetY(45);
$pdf->Cell(0, 10, 'Reporte de Usuarios Admin', 0, 1, 'C');
...
generateTable($pdf, $userDataFormatted, $userHeaders);

$pdf->Output('reporte_usuarios_admin.pdf', 'D');