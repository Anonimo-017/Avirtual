...
$pdf->SetKeywords('PDF, report, department');
...
$pdf->Cell(0, 10, 'Reporte de Departamentos', 0, 1, 'C');
...
generateTable($pdf, $departmentDataFormatted, $departmentHeaders);

$pdf->Output('reporte_departamentos.pdf', 'D');