								...
								<form action="delete_users.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
												...
												<td width="40">
												<a href="edit_user.php<?php echo '?id='.$id; ?>"   class="btn btn-success"><i class="icon-pencil icon-large"></i></a>
												</td>
									 ...
									 <button type="submit" name="delete_user" class="btn btn-danger"><i class="icon-trash icon-large"></i> Eliminar Seleccionados</button>
									</form>
                                </div>
                            </div>
                        </div>
